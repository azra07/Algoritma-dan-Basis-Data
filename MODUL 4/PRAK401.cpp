...
int main()
{
    ...
    if(menu==1){
        do {
            cout<<"Double Linked Link Non Circular(DLLNC) (Head)"<<endl;
            cout<<"============================================="<<endl;
        ...
        do{
            cout<<"Double Linked Link Non Circular(DLLNC) (Head dan Tail)"<<endl;
            cout<<"======================================================"<<endl;
            cout<<"1. Tambah Depan"<<endl;
            cout<<"2. Tambah Belakang"<<endl;
            cout<<"3. Tampilkan Data"<<endl;
        ...
        cout<<"\nTERIMA KASIH"<<endl;
        cout<<"Program was made by Putri Fatima Az'hara (2410817120001)."<<endl;
    }
}
...
void tambahDepanHT() {
    ...
    cout << "Data\""<<dataBaru<<"\" berhasil dimasukkkan di bagian depan.";
}
